...
export const OBSTACLES = {
  ...
  tree: { name: 'Tree', solid: true, tall: true, hp: 22, sprite: 'tree', blocksProjectile: true, barScale: 0.7, natural: true, ...WOOD },
  ...
  mushroom: { name: 'Giant Mushroom', solid: true, tall: false, hp: 8, sprite: 'mushroom', blocksProjectile: true, barScale: 0.6, natural: true, ...ORGANIC },
  vine: { name: 'Vines', solid: true, tall: false, hp: 6, sprite: 'vine', blocksProjectile: true, barScale: 0.45, natural: true, ...ORGANIC },
  ...
  bush: { name: 'Bush', solid: true, tall: false, cover: 2, hp: 4, sprite: 'bush', blocksProjectile: true, barScale: 0.5, natural: true, ...ORGANIC },
  log: { name: 'Fallen Log', solid: true, tall: false, cover: 2, hp: 8, sprite: 'log', blocksProjectile: true, barScale: 0.8, natural: true, ...WOOD },
  stump: { name: 'Stump', solid: true, tall: false, cover: 2, hp: 6, sprite: 'stump', blocksProjectile: true, barScale: 0.45, natural: true, ...WOOD },
  ...
  flower: { name: 'Fey Flowers', solid: false, tall: false, cover: 0, hp: null, sprite: 'flower', blocksProjectile: false, natural: true },
